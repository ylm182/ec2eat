...
- `lib/providers/`: asynchronous abortable provider contracts, fixed-wording fallback and explicit unavailable Places adapter. Laya scoring and Gemini/Weather/Calendar adapters are implemented but require configured live smoke tests; Laya remains M5.
